...
const STOP_WORDS = new Set([
  // English
  'what', 'is', 'for', 'are', 'the', 'and', 'to', 'in', 'of', 'how', 'can', 'i', 'you', 'we', 'they', 'he', 'she', 'it', 'on', 'at', 'by', 'from', 'with', 'about', 'whom', 'who',
  // Hindi
  'क्या', 'है', 'हैं', 'के', 'लिए', 'का', 'की', 'को', 'में', 'से', 'पर', 'और', 'या', 'हो', 'सकता', 'कैसे', 'कौन',
  // Gujarati
  'શું', 'છે', 'માટે', 'ના', 'ની', 'નું', 'ને', 'માં', 'થી', 'અને', 'અથવા', 'કેવી', 'રીતે', 'કોણ'
]);
